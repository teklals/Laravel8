            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ url('/admin/companymgmt') }}"></i> Company Mgmt <span class="fa fa-chevron-down"></span></a></li>                  
                  <li><a href="{{ url('/admin/home/addpage') }}"></i> Home <span class="fa fa-chevron-down"></span></a></li>
                  <li><a href=""></i> Services <span class="fa fa-chevron-down"></span></a></li>
                  <li><a href=""></i> Contact <span class="fa fa-chevron-down"></span></a></li>
                </ul>
              </div>
